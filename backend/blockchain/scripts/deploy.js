...
async function main() {
  ...
  // Register initial IoT devices in DeviceIdentity contract
  const initialDevices = [
    ["IOT001", "Temperature Sensor", "did:iot:IOT001#59f4538475de12dc", "0x378679C438F68168Cf736B33948111FCE028BD17", "SENSOR"],
    ["IOT002", "Humidity Sensor", "did:iot:IOT002#10eda9ebfedd0605", "0x378679C438F68168Cf736B33948111FCE028BD17", "SENSOR"],
    ["IOT003", "Motion Sensor", "did:iot:IOT003#e5ddf7771df8eda2", "0x378679C438F68168Cf736B33948111FCE028BD17", "SENSOR"],
    ["IOT004", "Door Sensor", "did:iot:IOT004#f7728fee797ee17f", "0x378679C438F68168Cf736B33948111FCE028BD17", "SENSOR"],
    ["IOT005", "Smart Camera", "did:iot:IOT005#30c196610028c9d6", "0x378679C438F68168Cf736B33948111FCE028BD17", "CAMERA"],
    ["IOT006", "Smart Motor", "did:iot:IOT006#9d98f4199b5ec8c9", "0x378679C438F68168Cf736B33948111FCE028BD17", "ACTUATOR"],
  ];

  for (const [id, name, did, addr, role] of initialDevices) {
    try {
      const tx = await deviceIdentity.contract.registerDevice(id, name, did, addr, role);
      await tx.wait();
      console.log(`Registered device on-chain: ${id}`);
    } catch (e) {
      console.warn(`Device ${id} registration notice:`, e.message);
    }
  }
