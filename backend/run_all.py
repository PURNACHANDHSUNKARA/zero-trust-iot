...
def setup_database():
    ...
    sslmode = os.getenv("PG_SSLMODE", "require" if db_url else "prefer")
    ...
    try:
        ...
        # Check connection to postgres server locally
        conn = psycopg2.connect(
            host=pg_host, port=pg_port, user=pg_user, password=pg_pass, dbname="postgres", sslmode=sslmode
        )
